...
- (void)layoutSubviews {
    ...
    CGFloat const imageViewEdgeHeight  = imageViewEdgeWidth*0.6;
    
    CGFloat const centerOfView    = self.bounds.size.width * 0.5;
    CGFloat const labelLineHeight = self.titleLabel.font.lineHeight;
    CGFloat const verticalMarginT = self.bounds.size.height - labelLineHeight - imageViewEdgeHeight;
...
+ (id)plusButton {
    ...
    UIImage *buttonImage = [UIImage imageNamed:@"icon_select_tabbar1"];
...
//    [button sizeToFit]; // or set frame in this way `button.frame = CGRectMake(0.0, 0.0, 250, 100);`
    button.frame = CGRectMake(0.0, 0.0, [UIScreen mainScreen].bounds.size.width/3, 49);
